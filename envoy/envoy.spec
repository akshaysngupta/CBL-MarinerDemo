...
#   1. wget https://github.com/envoyproxy/envoy/archive/refs/tags/v%{version}.zip -o %%{name}-%%{version}.zip
...
%install
install -D -m0755 bazel-bin/source/exe/envoy-static %{buildroot}%{_bindir}/envoy
